...
export PATH="$USR_HOME/mise/bin:$USR_HOME/bin:$USR_HOME/nvim/bin:$USR_HOME/go/bin:$USR_HOME/kitty.app/bin:$HOME/.local/bin:$FZF_HOME/bin:$CARGO_HOME/bin:$GOPATH/bin:$PATH"
